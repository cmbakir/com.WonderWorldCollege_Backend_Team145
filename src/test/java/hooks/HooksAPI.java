...
public class HooksAPI {
    ...
    public static void setUpApi(String userType) {
        ...
        if (userType.equals("admin") || userType.equals("teacher") || userType.equals("student") || userType.equals("adminAhmetEmail") || userType.equals("teacher2")|| userType.equals("adminPinar")) {

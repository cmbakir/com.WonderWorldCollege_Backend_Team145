Feature: As an administrator (admin) I want to be able to access Purpose List via API connection.
  ...
  Scenario Outline: WWCAPI-124 [TC_01 -> API_US001] Verify that a GET request to the `/api/visitorsPurposeList` endpoint with valid authorization returns
  ...
  Scenario: [WCAPI-125 [TC_02 -> API_US001] Verify that a GET request to /api/visitorsPurposeList with invalid authorization returns a 403 status code and a
  "failed" message.

Feature: As an administrator (admin), I want to be able to access the Notice information of the user with the given id via API connection.

  Scenario Outline: Successful Response with Valid Authorization and ID
  ...
  Scenario: Missing or Invalid ID with Valid Authorization
    * The api user constructs the base url with the "admin" token.
    * The api user sets "api/getNoticeById" path parameters.
  ...
  Scenario Outline: Response with Invalid Authorization

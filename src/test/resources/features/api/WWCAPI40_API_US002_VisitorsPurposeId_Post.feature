Feature: As an administrator (admin), I want to be able to access the Visitor Purpose information of the user whose id is
  ...
  Scenario Outline: [WWCAPI127 TC_01 -> API_US002]Verify that a POST request to `/api/visitorsPurposeId` with valid authorization and correct data returns a
  ...
  Scenario: [WWCAPI128 TC_02 -> API_US002]Verify that a POST request to `/api/visitorsPurposeId` without `id` and valid authorization returns a 203 status
  ...
  Scenario Outline:[WWCAPI129 TC_03 -> API_US002] Verify that a POST request to `/api/visitorsPurposeId` with invalid `id` and valid authorization returns a
  ...
  Scenario Outline: [WWCAPI130 TC_04 -> API_US002]Verify that a POST request to `/api/visitorsPurposeId` with invalid authorization returns a 403
